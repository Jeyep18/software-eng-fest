...
const OBJECTIVE_NOTICE: AudioStream = preload("res://game/assets/sfx/universfield-interface-124464.mp3")
...
static func objective_notice() -> void: play(OBJECTIVE_NOTICE, -11.0, 0.02)
